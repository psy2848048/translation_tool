...
# 페이스북 로그인
auth.add_url_rule('/facebook/signin', view_func=ctrl.faceobook_signin, methods=['GET'])
auth.add_url_rule('/facebook/authorized', view_func=ctrl.facebook_authorized, methods=['GET'])
